...
{ description := "A finitary statement of Szemerédi's theorem, that a subset of the natural numbers with positive upper density contains an arithmetic progression of any length.",
  authors := [
