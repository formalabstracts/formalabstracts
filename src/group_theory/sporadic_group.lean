import .basic .monster .presentation .suzuki .higman_sims .mclaughlin linear_algebra.basic data.real.basic .conway_groups .mathieu_group
noncomputable theory
open monster suzuki higman_sims mclaughlin conway_groups mathieu_group is_monoid_action
